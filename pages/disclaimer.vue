    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <h1>Disclaimer for WeeFreeGuide</h1>

          <p>
            If you require any more information or have any questions about our
            site's disclaimer, please feel free to contact us by email at
            weefreemusic@gmail.com. Our Disclaimer was generated with the help
            of the
          ...
          <h2>Disclaimers for WeeFreeGuide</h2>

          <p>
            All the information on this website - https://weefreeguide.xyz/ - is
            published in good faith and for general information purpose only.
            WeeFreeGuide does not make any warranties about the completeness,
            reliability and accuracy of this information. Any action you take
            upon the information you find on this website (WeeFreeGuide), is
            strictly at your own risk. WeeFreeGuide will not be liable for any

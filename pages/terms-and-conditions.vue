    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 offset-md-2">
          ...
          <p>Welcome to WeeFreeGuide!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of WeeFreeGuide's Website, located at https://weefreeguide.xyz/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use WeeFreeGuide if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing WeeFreeGuide, you agreed
            to use cookies in agreement with the WeeFreeGuide's Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, WeeFreeGuide and/or its licensors own the
            intellectual property rights for all material on WeeFreeGuide. All
            intellectual property rights are reserved. You may access this from
            WeeFreeGuide for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from WeeFreeGuide</li>
            <li>Sell, rent or sub-license material from WeeFreeGuide</li>
            <li>Reproduce, duplicate or copy material from WeeFreeGuide</li>
            <li>Redistribute content from WeeFreeGuide</li>
          </ul>
          ...
          <p>
            ...
            WeeFreeGuide does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of WeeFreeGuide,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            WeeFreeGuide shall not be liable for the Comments or for any
          ...
          <p>
            WeeFreeGuide reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant WeeFreeGuide a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of WeeFreeGuide;
          ...
          <p>
            ...
            sending an e-mail to WeeFreeGuide. Please include your name, your
          ...
          <p>
            No use of WeeFreeGuide's logo or other artwork will be allowed for
